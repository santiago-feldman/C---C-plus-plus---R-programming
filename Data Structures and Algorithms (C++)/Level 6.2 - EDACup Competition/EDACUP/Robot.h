...
public:
	 ...
	 */
	Robot(MQTTClient2* client, int number, int team);
	/**
	 ...
	 * @param state on (true) o off (false)
	 */
	void setDribbler(Vector3 ballPosition, bool state);
	/**
	...
	*/
	...
	/**
	 * @brief El robot arquero defiende los goles
	 * 
	 * @param ballPosition 
	 */
	virtual void defendGoal(Vector3 ballPosition);
